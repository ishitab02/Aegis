...
from aegis.api.routes import demo, detect, forensics, health, monitor, sentinel, vrf
...
app.include_router(monitor.router, prefix="/api/v1/monitor", tags=["Live Monitoring"])
